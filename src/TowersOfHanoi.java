...
public class TowersOfHanoi {
    ...
    public TowersOfHanoi(int n, boolean verbose) {
        ...
        for (int i = 0; i < 3; i++)       //every tower of hanoi array list has 3 items.
            pegs.add(new Stack<Integer>());
        // push disks onto peg 0, from biggest to smallest
        for (int i = n; i > 0; i--) //we add all the stacks (n), to the arraylist (1)
            pegs.get(0).push(i);
    }
    ...
    public static void main(String[] args) {
        TowersOfHanoi towers = new TowersOfHanoi(3, true);
